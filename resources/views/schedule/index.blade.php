...
@section('content')
    ...
    <h1 class="text-primary font-weight-bold m-4">Jadwal Karyawan</h1>

    @if (Auth::user()->positions->position_name == "Administrator" || Auth::user()->positions->position_name == "CEO")
    <div class="mx-3 my-4">
        <a href="/schedule/create" class="btn btn-info mx-2"> <i class="fa-solid fa-plus"></i> Tambah Jadwal</a>
        <a href="/schedulereport" class="btn btn-danger"><i class="fa-solid fa-print"></i> Export PDF</a>
    </div>
    @endif
                    ...
                    @forelse ($schedule as $key => $item)
                        <tr>
                            ...
                            <td>
                                ...
                                @else
                                <a href="/schedule/{{ $item->id }}" class="btn-sm btn-info px-3 py-2" style="text-decoration: none;color:white">Detail</a>
                                @endif
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <form action="/schedule/{{ $item->id }}" method="post" id="DeleteModal">
                                                        @csrf
                                                        @method('delete')
                                                        <input type="submit"
